    ...
    for typ, chips in chip_types.items():
        if typ == '\\74AC16374_16x1DFF':
            ...
            for instances in select.values():
                #ABC but only one mux per chip
                make_techmap(new_74151, mapping, instances, nets)
        elif typ == '\\74AC11086_4x1XOR2' or typ == '\\74AC86_4x1XOR2':
            mapping = {"{}A": "A", "{}B": "B", "{}Y": "Y"}
        ...
        elif typ == '\\74AC11032_4x1OR2' or typ == "\\74AC32_4x1OR2": #Added support for 74AC32 Quad 2-in OR
            mapping = {"{}A": "A", "{}B": "B", "{}Y": "Y"}
            make_abc(new_7432, mapping, chips, nets, 1)
        elif typ == '\\74AC11008_4x1AND2':
            mapping = {"{}A": "A", "{}B": "B", "{}Y": "Y"}
            make_abc(new_7408, mapping, chips, nets, 1)
        elif typ == '\\74AC11000_4x1NAND2' or '\\74AC00_4x1NAND2': # Added support for 74AC00
            mapping = {"{}A": "A", "{}B": "B", "{}Y": "Y"}
